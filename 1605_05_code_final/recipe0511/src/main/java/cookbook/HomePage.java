...
public class HomePage extends WebPage {
	...
	public HomePage(final PageParameters parameters) {
		...
		columns.add(new ExportablePropertyColumn<Contact>(Model.of("Name"),
				"name"));
		columns.add(new ExportablePropertyColumn<Contact>(Model.of("Email"),
				"email"));
		columns.add(new ExportablePropertyColumn<Contact>(Model.of("Phone"),
				"phone"));

		DefaultDataTable<Contact> contacts = new DefaultDataTable<Contact>(
