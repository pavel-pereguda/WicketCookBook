...
public abstract class OpenIdConsumer {
	...
	public void init(WebApplication application) {
		consumers = new MapMaker().expiration(5, TimeUnit.MINUTES).makeMap();
		application.mountBookmarkablePage("/openid/finish",
				OpenIdCallbackPage.class);
