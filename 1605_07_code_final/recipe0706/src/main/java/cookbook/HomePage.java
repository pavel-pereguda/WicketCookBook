...
public class HomePage extends WebPage {
	...
	public HomePage(final PageParameters parameters) {
		...
		form.add(new FeedbackPanel("username-feedback",
				new ComponentFeedbackMessageFilter(username))
		...
		form.add(new FeedbackPanel("password-feedback",
				new ComponentFeedbackMessageFilter(password))
				.setOutputMarkupId(true));
